...
function view_request() {
	...
	if(!win_complaint){
		win_complaint = new Ext.Window({
			applyTo:'cnt_win_complaint',
			autoHeight: true,
			layout:'fit',
			width:450,
			height:200,
	...
	win_complaint.show(this);
}
</script>
<!-- Containers for popup windows -->
<div id="cnt_win_complaint" class="x-hidden"><!-- employee browser container --></div>
