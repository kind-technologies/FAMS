...
<head>
<title>ITCottage Sri Lanka - Simple Smart SolutionS</title>
...
function fullscreen(url) {
  ...
  features += ",left=0,top=0,scrollbars=1,resizable=1,status=1";
...
<div id="container">
  ...
  <div id="services">
    <div class="service_box">
      <center>
        ...
        <p> FAMS is the first free and open source project initiated by ITC-RC. </p>
        <div class="more_button"><a href="#">Read more</a></div>
      </center>
    </div>
    <div class="service_box">
      <center>
        ...
        <h2>FAMS Demo</h2>
        <p>Checkout the current status of FAMS. Click here to enter FAMS project demo. <br/><br/> </p>
        <div class="more_button">
        		<a href="#" onclick="fullscreen('/users/login')" >Launch demo</a>
        	</div>
      </center>
    </div>
    <div class="service_box">
      <center>
        ...
        <p>You can download the latest source from Sourcefroge. SF homepage of this project is available here.</p>
  ...
  <div id="newssection">
    ...
    <div class="newsbox">
      <h4>FAMS now on Sourceforge</h4>
      <p>FAMS svn repository now available at Sourceforge. <a href="#">more...</a></p>
    </div>
    <div class="newsbox">
      <h4>FOSS ERP Solution</h4>
